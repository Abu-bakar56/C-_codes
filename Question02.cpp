...
void delemployee(Employee *employeeToDelete);
...
Employee *delemployee()
{
    ...
    while (temp != NULL)
    {
        ...
        {
            cout << "Can't Find Employee with Id " << da << " in the record. " << endl;
            break;
        }
        else
        {
...
void updateemployee()
{
    ...
    if (head == NULL)
    {
        cout << " No record in this list" << endl;
    }
    else
    {
        Employee *temp = head;
        while (temp != NULL)
        {
            ...
            {
                cout << "Can't Find Employee with Id " << iD << " in the record. " << endl;
                break;
            }
            else
            {
...
void labelMenu()
{
    while (true)
    {
        ...
        cout << "5. For Update Specific Employees Details " << endl;
        cout << "6. Log Out" << endl;
